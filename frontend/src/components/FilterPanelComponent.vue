...
type ContinentName = "Africa" | "Antarctica" | "Asia" | "Australia" | "Europe" | "North America" | "South America";
...
/**
 * Removes a time slot at the index.
 *
...
/**
 * Emits the search event with the current filter values.
 */
function search() {
    emit("search", {
        location: {
        ...
        measurements: {
            temperature: measurements.temperature ? { from: temp.from, to: temp.to, unit: temp.unit } : null,
        },
        dateRange: dateRange,
        times: times.value,
    });
            ...
            <div class="mb-2">
                ...
                <div class="flex items-center justify-between mb-2">
                    <label class="flex items-center">
                        <input type="checkbox" v-model="measurements.temperature" class="mr-2" />
                ...
                <div v-if="measurements.temperature" class="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                    <!-- From -->
                    <div>
