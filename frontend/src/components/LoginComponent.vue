...
<template>
  <form @submit.prevent="handleSubmit" autocomplete="false">
    <div class="mb-3">
      ...
      <input type="text" class="" id="exampleInputUsername1" v-model="formData.username"
        aria-describedby="usernameHelp" />
      <div id="usernameHelp" class="form-text font-bold">We'll never share your username with anyone else.</div>
    </div>
    <div class="mb-3">
